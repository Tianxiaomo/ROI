...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  // roialignrotatedpadding
  m.def(
      "roi_align_rotated_padding_forward",
      &ROIAlignRotatedPadding_forward,
      "Forward pass for Rotated ROI-Align Padding Operator");
  m.def(
      "roi_align_rotated_padding_backward",
      &ROIAlignRotatedPadding_backward,
